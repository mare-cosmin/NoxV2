...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double FORWARD_OFFSET = 2.362; // in; offset of the lateral wheel
    public static double X_MULTIPLIER = 0.98068113506;
    public static double Y_MULTIPLIER = 0.98773502141;
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        super(Arrays.asList(
                new Pose2d(1.65, 2.85, 0), // left
                new Pose2d(0.87, -2.87, Math.toRadians(180)), // right
